...
const PlinkoGameBoard = () => {
    ...
    const [dataPointMapping, setDataPointMapping] = useState({"0.5": [], "1": [], "1.1": [], "1.2": [], "1.4": [], "2": [], "9": [], "16": []}) 
                ...
                if (text) {
                  if (Matter.Collision.collides(body, body2) != null) {
                    if (body2.render.text){
                      console.log(body);
                      appendToDataMapping(body2.render.text, body.render.startLocation)
                    }
    ...
    const addRandomBall = () => {
      ...
      const newBall = Bodies.circle(startLocation, 0, 7, {
        restitution: 0.5,
        render: { fillStyle: "#00FF00", ball: "true", startLocation: startLocation },
    ...
    const addPreDeterminedBall = (startLocation) => {
      const { Bodies, Composite } = Matter;
      //const startLocation = Math.random() * (500 - 300) + 300;
      const newBall = Bodies.circle(startLocation, 0, 7, {
        restitution: 0.5,
